...
It determines how you will be spending your time, who you will be spending it with, and what you will learn and gain from the expenditure.
One who cannot convince the person on the other side of the table that one should be hired, shall remain unhired.
Regardless of ability or merit.
Interview confidence takes practice.
You can't lift 200kg on your first try, you need a specific type of training.
You can't excel at interviews without the right preparation.
The best way to improve your interviewing is to do interviews and learn from your mistakes.
The second best way to improve your interviewing is to learn from the mistakes of others, and ensure your preparation matches closely what you will encounter.
...
The preparation books mentioned above provided great practice questions, but I feel there is more to be said on interview form.
...
In that case, read through the solutions and pay attention to how the interviewers expect you to present the answers and to get an idea of how interviews usually progress.
...
The former text is a classic, but it is starting to show its age.
...
While I made every attempt to record my encounters, I am unfortunately an unreliable narrator.
...
Rather, I will focus on what to answer and emphasize \emph{how} to answer it.
...
The first two times I got this question I got stuck after giving a simple answers and not knowing how to convince the interviewer I understood the principles behind it.
...
When person 50 finds the seat occupied, he becomes the drunkard and we now have the same problem as before, but with 51 people instead of 100. The open seats will be
...
We want to determine $p_{100}$, which gives us the answer to the question.
...
\begin{enumerate}
  ...
  \item When the longest piece is more than the sum of the other two
\end{enumerate}
You will find that only the first case allows you to draw a triangle (The second case is a degenerate case where the triangle you draw becomes a line).
...
\subsection{SQL query practice script}
\label{ap:sqlite}
